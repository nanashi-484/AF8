...
module TESTBED;
    ...
    task automatic drive_cycle(
        ...
        acc_clear <= clr;
        @(posedge clk);
        #1;  // let combinational logic settle after NBA update
    endtask
    ...
    initial begin
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h38, 8'h38, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'hB8, 8'h38, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'hB8, 8'hB8, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h40, 8'h44, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'hC0, 8'hC0, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h7F, 8'h38, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h7F, 8'h30, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h7F, 8'h40, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h78, 8'h78, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h01, 8'h38, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h07, 8'h38, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h01, 8'h01, 1'b1, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h08, 8'h08, 1'b1, ref_acc);
        ...
        // -- NaN propagation --
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h7C, 8'h38, 1'b1, ref_acc);
        drive_cycle(8'h7C, 8'h38, 1'b1);
        repeat (LATENCY - 1) @(posedge clk);
        check(exp_val, 18, "NaN: NaN * 1.0 = NaN");

        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h38, 8'hFC, 1'b1, ref_acc);
        ...
        for (int i = 0; i < 5; i = i + 1) begin
            exp_val = fp8_mac_ref(8'h38, 8'h38, (i == 0), ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h38, 8'h40, 1'b1, ref_acc);
        drive_cycle(8'h38, 8'h40, 1'b1);
        repeat (LATENCY - 1) @(posedge clk);
        check(exp_val, 30, "Cancel: 1.0*2.0 = 2.0");

        exp_val = fp8_mac_ref(8'hB8, 8'h40, 1'b0, ref_acc);
        ...
        for (int i = 0; i < 3; i = i + 1) begin
            exp_val = fp8_mac_ref(8'h01, 8'h38, (i == 0), ref_acc);
        ...
        exp_val = fp8_mac_ref(8'h7F, 8'h30, 1'b0, ref_acc);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h38, 8'h40, 1'b1, ref_acc);  // 1.0*2.0=2.0
        drive_cycle(8'h38, 8'h40, 1'b1);
        repeat (LATENCY - 1) @(posedge clk);
        check(exp_val, 60, "Sanity: acc_clear=1 → 2.0");

        exp_val = fp8_mac_ref(8'h38, 8'h44, 1'b0, ref_acc);  // +3.0 → 5.0
        drive_cycle(8'h38, 8'h44, 1'b0);
        repeat (LATENCY - 1) @(posedge clk);
        check(exp_val, 61, "Sanity: acc_clear=0 → 5.0");

        exp_val = fp8_mac_ref(8'h38, 8'h38, 1'b1, ref_acc);  // clear + 1.0 → 1.0
        drive_cycle(8'h38, 8'h38, 1'b1);
        repeat (LATENCY - 1) @(posedge clk);
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h40, 8'h40, 1'b1, ref_acc);  // 2.0*2.0=4.0
        ...
        ref_acc = 0.0;
        exp_val = fp8_mac_ref(8'h38, 8'h38, 1'b1, ref_acc);  // 1.0*1.0=1.0
        drive_cycle(8'h38, 8'h38, 1'b1);
        repeat (LATENCY - 1) @(posedge clk);
        ...
        begin
            ...
            for (int i = 0; i < RANDOM_COUNT; i = i + 1) begin
                ...
                exp_val = fp8_mac_ref(ra, rb, rclr, ref_acc);
